...
- [Paxos算法详解](#paxos算法详解)
  - [1. Paxos算法背景](#1-paxos算法背景)
  - [2. Paxos算法流程](#2-paxos算法流程)
  - [3. Multi-Paxos算法](#3-multi-paxos算法)
  - [4. 附Paxos算法推导过程](#4-附paxos算法推导过程)

作为分布式一致性代名词的Paxos算法号称是最难理解的算法。本文试图用通俗易懂的语言讲述Paxos算法。
...
![Paxos算法中的角色](./images/Paxos算法中的角色.png)
...
![Paxos算法流程](./images/Paxos算法流程.png)
...
![Paxos算法伪代码](./images/Paxos算法伪代码.png)
...
![Paxos算法实例1](./images/Paxos算法实例1.png)
...
![Paxos算法形成活锁](./images/Paxos算法形成活锁.png)
...
![Multi-Paxos流程](./images/Multi-Paxos流程.png)
